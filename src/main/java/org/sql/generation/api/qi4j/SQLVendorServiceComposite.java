...
//            return this._qi4j.getServiceDescriptor(this._meAsService).metaInfo(SQLVendor.class); Qi4jSPI#getServiceDescriptor() doesn't exist anymore
            return null;
        }
