...
public class TableReferenceProcessing {
    ...
    public static abstract class AbstractTableNameProcessor<TableNameType extends TableName>
        ...
        protected AbstractTableNameProcessor(final Class<? extends TableNameType> realType) {
            super(realType);
        }

        @Override
        protected void doProcess(final SQLProcessorAggregator processor, final TableNameType object,
                                 final StringBuilder builder) {
            final String schemaName = object.getSchemaName();
    ...
    public static class TableNameFunctionProcessor extends
        ...
        protected TableNameFunctionProcessor(final Class<? extends TableNameFunction> realType) {
            super(realType);
        }

        @Override
        protected void doProcessTableName(final SQLProcessorAggregator processor,
                                          final TableNameFunction object,
                                          final StringBuilder builder) {
    ...
    public static class TableNameDirectProcessor extends
        ...
        protected TableNameDirectProcessor(final Class<? extends TableNameDirect> realType) {
            super(realType);
        }

        @Override
        protected void doProcessTableName(final SQLProcessorAggregator processor,
                                          final TableNameDirect object,
                                          final StringBuilder builder) {
    ...
    public static abstract class TableReferencePrimaryProcessor<TableReferenceType extends TableReferencePrimary>
        ...
        public TableReferencePrimaryProcessor(final Class<TableReferenceType> realType) {
            super(realType);
        }

        @Override
        protected void doProcess(final SQLProcessorAggregator processor, final TableReferenceType object,
                                 final StringBuilder builder) {
        ...
        protected void processTableAlias(final SQLProcessorAggregator processor, final TableAlias tableAlias,
                                         final StringBuilder builder) {
            final String alias = tableAlias.getTableAlias();
    ...
    public static class TableReferenceByNameProcessor extends
        ...
        @Override
        protected void doProcessTablePrimary(final SQLProcessorAggregator processor,
                                             final TableReferenceByName object,
                                             final StringBuilder builder) {
    ...
    public static class TableReferenceByExpressionProcessor extends
        ...
        @Override
        protected void doProcessTablePrimary(final SQLProcessorAggregator processor,
                                             final TableReferenceByExpression tableRef,
                                             final StringBuilder builder) {
    ...
    public static abstract class JoinedTableProcessor<JoinedTableType extends JoinedTable> extends
        ...
        public JoinedTableProcessor(final Class<JoinedTableType> realType) {
            super(realType);
        }

        @Override
        protected void doProcess(final SQLProcessorAggregator processor, final JoinedTableType table,
                                 final StringBuilder builder) {
        ...
        protected void processJoinType(final JoinType joinType, final StringBuilder builder) {
            if (joinType != null) {
    ...
    public static class CrossJoinedTableProcessor extends JoinedTableProcessor<CrossJoinedTable> {
        ...
        @Override
        protected void doProcessJoinedTable(final SQLProcessorAggregator processor,
                                            final CrossJoinedTable table,
                                            final StringBuilder builder) {
    ...
    public static class NaturalJoinedTableProcessor extends
        ...
        @Override
        protected void doProcessJoinedTable(final SQLProcessorAggregator processor,
                                            final NaturalJoinedTable table,
                                            final StringBuilder builder) {
    ...
    public static class QualifiedJoinedTableProcessor extends
        ...
        @Override
        protected void doProcessJoinedTable(final SQLProcessorAggregator processor,
                                            final QualifiedJoinedTable table,
                                            final StringBuilder builder) {
            this.processJoinType(table.getJoinType(), builder);
            processor.process(table.getRight().asTypeable(), builder);
    ...
    public static class JoinConditionProcessor extends AbstractProcessor<JoinCondition> {
        ...
        @Override
        protected void doProcess(final SQLProcessorAggregator processor, final JoinCondition condition,
                                 final StringBuilder builder) {
    ...
    public static class NamedColumnsJoinProcessor extends AbstractProcessor<NamedColumnsJoin> {
        ...
        @Override
        protected void doProcess(final SQLProcessorAggregator processor, final NamedColumnsJoin join,
                                 final StringBuilder builder) {
