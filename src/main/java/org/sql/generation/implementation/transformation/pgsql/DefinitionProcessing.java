...
public class DefinitionProcessing {
    public static class PGColumnDefinitionProcessor extends ColumnDefinitionProcessor {
        ...
        public PGColumnDefinitionProcessor(final Map<Class<?>, String> dataTypeSerialNames) {
        ...
        protected void processDataType(final SQLProcessorAggregator aggregator, final ColumnDefinition object,
            ...
            if (autoGenPolicy == null) {
                ...
                if (AutoGenerationPolicy.BY_DEFAULT.equals(autoGenPolicy)) {
                    ...
                    for (final Map.Entry<Class<?>, String> entry : this._dataTypeSerialNames.entrySet()) {
