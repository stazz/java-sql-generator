...
public class IsNotNullPredicateImpl extends UnaryPredicateImpl<IsNotNullPredicate>
    ...
    public IsNotNullPredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression expression) {
        this(processor, IsNotNullPredicate.class, expression);
    }

    protected IsNotNullPredicateImpl(final SQLProcessorAggregator processor,
                                     final Class<? extends IsNotNullPredicate> predicateClass, final NonBooleanExpression expression) {
