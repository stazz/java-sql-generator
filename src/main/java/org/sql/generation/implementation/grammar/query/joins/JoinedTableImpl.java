...
public abstract class JoinedTableImpl<TableReferenceType extends JoinedTable> extends
    ...
    protected JoinedTableImpl(final SQLProcessorAggregator processor,
                              final Class<? extends TableReferenceType> tableReferenceClass, final TableReference left, final TableReference right) {
    ...
    @Override
    protected boolean doesEqual(final TableReferenceType another) {
