...
public class CorrespondingSpecImpl extends SQLSyntaxElementBase<CorrespondingSpec, CorrespondingSpec>
    ...
    public CorrespondingSpecImpl(final SQLProcessorAggregator processor, final ColumnNameList columnNames) {
        this(processor, CorrespondingSpec.class, columnNames);
    }

    protected CorrespondingSpecImpl(final SQLProcessorAggregator processor, final Class<? extends CorrespondingSpec> implClass,
                                    final ColumnNameList columnNames) {
    ...
    @Override
    protected boolean doesEqual(final CorrespondingSpec another) {
