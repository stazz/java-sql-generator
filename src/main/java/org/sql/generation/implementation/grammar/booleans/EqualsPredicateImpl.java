...
public class EqualsPredicateImpl extends BinaryPredicateImpl<EqualsPredicate>
    ...
    public EqualsPredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left, final NonBooleanExpression right) {
        this(processor, EqualsPredicate.class, left, right);
    }

    protected EqualsPredicateImpl(final SQLProcessorAggregator processor, final Class<? extends EqualsPredicate> predicateClass,
