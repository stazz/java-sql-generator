...
public class DirectLiteralImpl extends NonBooleanExpressionImpl<DirectLiteral>
    ...
    public DirectLiteralImpl(final SQLProcessorAggregator processor, final String literal) {
        this(processor, DirectLiteral.class, literal);
    }

    protected DirectLiteralImpl(final SQLProcessorAggregator processor, final Class<? extends DirectLiteral> implClass,
    ...
    @Override
    protected boolean doesEqual(final DirectLiteral another) {
