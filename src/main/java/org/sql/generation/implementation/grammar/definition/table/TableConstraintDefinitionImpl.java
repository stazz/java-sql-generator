...
public class TableConstraintDefinitionImpl extends SQLSyntaxElementBase<TableElement, TableConstraintDefinition>
    ...
    public TableConstraintDefinitionImpl(final SQLProcessorAggregator processor, final String name, final TableConstraint constraint,
    ...
    protected TableConstraintDefinitionImpl(final SQLProcessorAggregator processor,
                                            final Class<? extends TableConstraintDefinition> realImplementingType, final String name, final TableConstraint constraint,
                                            final ConstraintCharacteristics characteristics) {
    ...
    @Override
    protected boolean doesEqual(final TableConstraintDefinition another) {
