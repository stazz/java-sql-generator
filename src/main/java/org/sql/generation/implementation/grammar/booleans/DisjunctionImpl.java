...
public class DisjunctionImpl extends ComposedBooleanExpressionImpl<Disjunction>
    ...
    public DisjunctionImpl(final SQLProcessorAggregator processor, final BooleanExpression left, final BooleanExpression right) {
        this(processor, Disjunction.class, left, right);
    }

    protected DisjunctionImpl(final SQLProcessorAggregator processor, final Class<? extends Disjunction> expressionClass,
