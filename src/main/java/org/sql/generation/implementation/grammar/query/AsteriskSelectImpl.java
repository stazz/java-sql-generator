...
public class AsteriskSelectImpl extends SelectColumnClauseImpl<AsteriskSelect>
    ...
    public AsteriskSelectImpl(final SQLProcessorAggregator processor, final SetQuantifier quantifier) {
        this(processor, AsteriskSelect.class, quantifier);
    }

    public AsteriskSelectImpl(final SQLProcessorAggregator processor, final Class<? extends AsteriskSelect> type,
