...
public class NotBetweenPredicateImpl extends MultiPredicateImpl<NotBetweenPredicate>
    ...
    public NotBetweenPredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left,
    ...
    protected NotBetweenPredicateImpl(final SQLProcessorAggregator processor,
                                      final Class<? extends NotBetweenPredicate> predicateClass, final NonBooleanExpression left, final NonBooleanExpression minimum,
