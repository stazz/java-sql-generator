...
public class ExistsPredicateImpl extends UnaryPredicateImpl<ExistsPredicate>
    ...
    public ExistsPredicateImpl(final SQLProcessorAggregator processor, final QueryExpression query) {
        this(processor, ExistsPredicate.class, query);
    }

    protected ExistsPredicateImpl(final SQLProcessorAggregator processor, final Class<? extends ExistsPredicate> predicateClass,
