...
public class TableReferencePrimaryImpl<TableReferenceType extends TableReferencePrimary> extends
    ...
    public TableReferencePrimaryImpl(final SQLProcessorAggregator processor,
                                     final Class<? extends TableReferenceType> tableReferenceClass, final TableAlias alias) {
