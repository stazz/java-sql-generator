...
public class ColumnSourceByValuesImpl extends DynamicColumnSourceImpl<ColumnSourceByValues>
    ...
    public ColumnSourceByValuesImpl(final SQLProcessorAggregator processor, final ColumnNameList columnNames,
                                    final List<ValueExpression> expressions) {
        this(processor, ColumnSourceByValues.class, columnNames, expressions);
    }

    protected ColumnSourceByValuesImpl(final SQLProcessorAggregator processor,
                                       final Class<? extends ColumnSourceByValues> expressionClass, final ColumnNameList columnNames,
                                       final List<ValueExpression> expressions) {
        ...
        this._expressions = Collections.unmodifiableList(new ArrayList<>(expressions));
    }
