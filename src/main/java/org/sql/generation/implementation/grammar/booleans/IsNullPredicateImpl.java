...
public class IsNullPredicateImpl extends UnaryPredicateImpl<IsNullPredicate>
    ...
    public IsNullPredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression expression) {
        this(processor, IsNullPredicate.class, expression);
    }

    protected IsNullPredicateImpl(final SQLProcessorAggregator processor, final Class<? extends IsNullPredicate> predicateClass,
