...
public class PgSQLInsertStatementBuilderImpl extends InsertStatementBuilderImpl implements
    ...
    public PgSQLInsertStatementBuilderImpl(final SQLProcessorAggregator processor) {
        super(processor);
    }

    @Override
    public PgSQLInsertStatementBuilder setReturningClause(final SelectColumnClause clause) {
