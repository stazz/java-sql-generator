...
public class LikePredicateImpl extends BinaryPredicateImpl<LikePredicate>
    ...
    public LikePredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left, final NonBooleanExpression right) {
        this(processor, LikePredicate.class, left, right);
    }

    protected LikePredicateImpl(final SQLProcessorAggregator processor, final Class<? extends LikePredicate> predicateClass,
