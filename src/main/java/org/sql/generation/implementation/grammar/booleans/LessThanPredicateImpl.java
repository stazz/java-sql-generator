...
public class LessThanPredicateImpl extends BinaryPredicateImpl<LessThanPredicate>
    ...
    public LessThanPredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left,
                                 final NonBooleanExpression right) {
        this(processor, LessThanPredicate.class, left, right);
    }

    protected LessThanPredicateImpl(final SQLProcessorAggregator processor,
                                    final Class<? extends LessThanPredicate> predicateClass, final NonBooleanExpression left, final NonBooleanExpression right) {
