...
public class DropSchemaStatementImpl extends DropStatementImpl<DropSchemaStatement>
    ...
    public DropSchemaStatementImpl(final SQLProcessorAggregator processor, final DropBehaviour dropBehaviour, final String schemaName) {
        this(processor, DropSchemaStatement.class, ObjectType.SCHEMA, dropBehaviour, schemaName);
    }

    protected DropSchemaStatementImpl(final SQLProcessorAggregator processor,
                                      final Class<? extends DropSchemaStatement> realImplementingType, final ObjectType whatToDrop, final DropBehaviour dropBehaviour,
    ...
    @Override
    protected boolean doesEqual(final DropSchemaStatement another) {
