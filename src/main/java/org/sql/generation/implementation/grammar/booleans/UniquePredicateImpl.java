...
public class UniquePredicateImpl extends UnaryPredicateImpl<UniquePredicate>
    ...
    public UniquePredicateImpl(final SQLProcessorAggregator processor, final QueryExpression query) {
        this(processor, UniquePredicate.class, query);
    }

    protected UniquePredicateImpl(final SQLProcessorAggregator processor, final Class<? extends UniquePredicate> predicateClass,
