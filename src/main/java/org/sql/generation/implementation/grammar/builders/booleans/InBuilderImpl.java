...
public class InBuilderImpl extends SQLBuilderBase
    ...
    public InBuilderImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left) {
        super(processor);
    ...
    @Override
    public InBuilder addValues(final NonBooleanExpression... expressions) {
        NullArgumentException.validateNotNull("expressions", expressions);
        for (final NonBooleanExpression exp : expressions) {
