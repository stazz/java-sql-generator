...
public class TableAliasImpl extends SQLSyntaxElementBase<TableAlias, TableAlias>
    ...
    public TableAliasImpl(final SQLProcessorAggregator processor, final String tableAlias, final ColumnNameList columnNames) {
        this(processor, TableAlias.class, tableAlias, columnNames);
    }

    protected TableAliasImpl(final SQLProcessorAggregator processor, final Class<? extends TableAlias> implementingClass,
                             final String tableAlias, final ColumnNameList columnNames) {
    ...
    @Override
    protected boolean doesEqual(final TableAlias another) {
        return this._tableAlias.equals(another.getTableAlias())
                && TypeableImpl.bothNullOrEquals(this._columnAliases, another.getColumnAliases());
    }
