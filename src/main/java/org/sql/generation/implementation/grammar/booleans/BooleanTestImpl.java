...
public class BooleanTestImpl extends ComposedBooleanExpressionImpl<BooleanTest>
    ...
    public BooleanTestImpl(final SQLProcessorAggregator processor, final BooleanExpression expression, final TestType testType,
                           final TruthValue truthValue) {
        this(processor, BooleanTest.class, expression, testType, truthValue);
    }

    protected BooleanTestImpl(final SQLProcessorAggregator processor, final Class<? extends BooleanTest> expressionClass,
                              final BooleanExpression expression, final TestType testType, final TruthValue truthValue) {
