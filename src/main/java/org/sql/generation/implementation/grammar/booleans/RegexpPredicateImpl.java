...
public class RegexpPredicateImpl extends BinaryPredicateImpl<RegexpPredicate>
    ...
    public RegexpPredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left, final NonBooleanExpression right) {
        this(processor, RegexpPredicate.class, left, right);
    }

    protected RegexpPredicateImpl(final SQLProcessorAggregator processor, final Class<? extends RegexpPredicate> predicateClass,
