...
public class LikeClauseImpl extends SQLSyntaxElementBase<TableElement, LikeClause>
    ...
    public LikeClauseImpl(final SQLProcessorAggregator processor, final TableNameDirect tableName) {
        this(processor, LikeClause.class, tableName);
    }

    protected LikeClauseImpl(final SQLProcessorAggregator processor, final Class<? extends LikeClause> realImplementingType,
                             final TableNameDirect tableName) {
    ...
    @Override
    protected boolean doesEqual(final LikeClause another) {
