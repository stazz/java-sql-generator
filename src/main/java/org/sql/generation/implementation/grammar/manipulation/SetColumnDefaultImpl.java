...
public class SetColumnDefaultImpl extends SQLSyntaxElementBase<AlterColumnAction, SetColumnDefault>
    ...
    public SetColumnDefaultImpl(final SQLProcessorAggregator processor, final String colDefault) {
        this(processor, SetColumnDefault.class, colDefault);
    }

    protected SetColumnDefaultImpl(final SQLProcessorAggregator processor,
                                   final Class<? extends SetColumnDefault> realImplementingType, final String colDefault) {
    ...
    @Override
    protected boolean doesEqual(final SetColumnDefault another) {
