...
public class GreaterThanPredicateImpl extends BinaryPredicateImpl<GreaterThanPredicate>
    ...
    public GreaterThanPredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left,
                                    final NonBooleanExpression right) {
        this(processor, GreaterThanPredicate.class, left, right);
    }

    protected GreaterThanPredicateImpl(final SQLProcessorAggregator processor,
                                       final Class<? extends GreaterThanPredicate> predicateClass, final NonBooleanExpression left, final NonBooleanExpression right) {
