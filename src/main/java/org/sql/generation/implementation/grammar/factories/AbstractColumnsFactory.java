...
public abstract class AbstractColumnsFactory extends SQLFactoryBase
    ...
    protected AbstractColumnsFactory(final SQLVendor vendor, final SQLProcessorAggregator processor) {
        super(vendor, processor);
    }

    @Override
    public ColumnReferenceByName colName(final String colName) {
