...
public class NamedColumnsJoinImpl extends JoinSpecificationImpl<NamedColumnsJoin>
    ...
    public NamedColumnsJoinImpl(final SQLProcessorAggregator processor, final ColumnNameList columnNames) {
        this(processor, NamedColumnsJoin.class, columnNames);
    }

    protected NamedColumnsJoinImpl(final SQLProcessorAggregator processor, final Class<? extends NamedColumnsJoin> implClass,
    ...
    @Override
    protected boolean doesEqual(final NamedColumnsJoin another) {
