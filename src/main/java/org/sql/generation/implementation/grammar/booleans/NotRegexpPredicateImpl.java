...
public class NotRegexpPredicateImpl extends BinaryPredicateImpl<NotRegexpPredicate>
    ...
    public NotRegexpPredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left,
                                  final NonBooleanExpression right) {
        this(processor, NotRegexpPredicate.class, left, right);
    }

    protected NotRegexpPredicateImpl(final SQLProcessorAggregator processor,
                                     final Class<? extends NotRegexpPredicate> predicateClass, final NonBooleanExpression left, final NonBooleanExpression right) {
