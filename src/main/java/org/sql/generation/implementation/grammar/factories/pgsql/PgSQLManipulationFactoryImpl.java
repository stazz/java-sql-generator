...
public class PgSQLManipulationFactoryImpl extends DefaultManipulationFactory
    ...
    public PgSQLManipulationFactoryImpl(final PostgreSQLVendor vendor, final SQLProcessorAggregator processor) {
        super(vendor, processor);
    }

    @Override
    public PgSQLDropTableOrViewStatement createDropTableOrViewStatement(final TableNameDirect tableName, final ObjectType theType,
    ...
    @Override
    public PgSQLDropTableOrViewStatement createDropTableOrViewStatement(final TableNameDirect tableName, final ObjectType theType,
                                                                        final DropBehaviour dropBehaviour, final Boolean useIfExists) {
