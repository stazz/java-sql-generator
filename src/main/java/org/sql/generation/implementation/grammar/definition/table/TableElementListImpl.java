...
public class TableElementListImpl extends SQLSyntaxElementBase<TableContentsSource, TableElementList>
    ...
    public TableElementListImpl(final SQLProcessorAggregator processor, final List<TableElement> elements) {
        this(processor, TableElementList.class, elements);
    }

    protected TableElementListImpl(final SQLProcessorAggregator processor,
                                   final Class<? extends TableElementList> realImplementingType, final List<TableElement> elements) {
    ...
    @Override
    protected boolean doesEqual(final TableElementList another) {
