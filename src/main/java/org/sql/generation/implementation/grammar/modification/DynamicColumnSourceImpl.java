...
public abstract class DynamicColumnSourceImpl<ColumnSourceType extends DynamicColumnSource> extends
    ...
    protected DynamicColumnSourceImpl(final SQLProcessorAggregator processor,
                                      final Class<? extends ColumnSourceType> expressionClass, final ColumnNameList columnNames) {
    ...
    @Override
    protected boolean doesEqual(final ColumnSourceType another) {
