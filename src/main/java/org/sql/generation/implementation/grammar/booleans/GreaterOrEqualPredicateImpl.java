...
public class GreaterOrEqualPredicateImpl extends BinaryPredicateImpl<GreaterOrEqualPredicate>
    ...
    public GreaterOrEqualPredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left,
                                       final NonBooleanExpression right) {
        this(processor, GreaterOrEqualPredicate.class, left, right);
    }

    protected GreaterOrEqualPredicateImpl(final SQLProcessorAggregator processor,
                                          final Class<? extends GreaterOrEqualPredicate> predicateClass, final NonBooleanExpression left, final NonBooleanExpression right) {
