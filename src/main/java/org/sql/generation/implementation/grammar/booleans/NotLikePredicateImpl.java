...
public class NotLikePredicateImpl extends BinaryPredicateImpl<NotLikePredicate>
    ...
    public NotLikePredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left, final NonBooleanExpression right) {
        this(processor, NotLikePredicate.class, left, right);
    }

    protected NotLikePredicateImpl(final SQLProcessorAggregator processor, final Class<? extends NotLikePredicate> predicateClass,
