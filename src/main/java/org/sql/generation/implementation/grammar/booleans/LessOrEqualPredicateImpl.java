...
public class LessOrEqualPredicateImpl extends BinaryPredicateImpl<LessOrEqualPredicate>
    ...
    public LessOrEqualPredicateImpl(final SQLProcessorAggregator processor, final NonBooleanExpression left,
                                    final NonBooleanExpression right) {
        this(processor, LessOrEqualPredicate.class, left, right);
    }

    protected LessOrEqualPredicateImpl(final SQLProcessorAggregator processor,
                                       final Class<? extends LessOrEqualPredicate> predicateClass, final NonBooleanExpression left, final NonBooleanExpression right) {
