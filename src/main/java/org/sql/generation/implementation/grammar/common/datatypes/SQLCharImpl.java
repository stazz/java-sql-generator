...
public final class SQLCharImpl extends TypeableImpl<SQLDataType, SQLChar>
    ...
    public SQLCharImpl(final Boolean isVarying, final Integer length) {
        super(SQLChar.class);
    ...
    @Override
    protected boolean doesEqual(final SQLChar another) {
        return this._isVarying.equals(another.isVarying()) && TypeableImpl.bothNullOrEquals(this._length, another.getLength());
    }
