...
public abstract class AbstractQueryTest extends AbstractSQLSyntaxTest {
    protected void logQuery(final SQLVendor vendor, final QueryExpression query) {
    ...
    public void query1()
        ...
        final ColumnsBuilder innerSelectCols = q.columnsBuilder(SetQuantifier.DISTINCT).addUnnamedColumns(
                c.colName("t0", "entity_pk"), c.colName("t0", "entity_identity"));

        final TableReferenceBuilder join = t.tableBuilder(
        ...
        final BooleanExpression innerWhere = b.booleanBuilder(
        ...
        final QuerySpecificationBuilder builder = q.querySpecificationBuilder();
        builder.setSelect(innerSelectCols);
        builder.getFrom().addTableReferences(join);
        builder.getWhere().reset(innerWhere);


        final QuerySpecificationBuilder select =
        ...
        final QueryExpression query = q.createQuery(q.queryBuilder(select.createExpression()).createExpression());
    ...
    public void query2()
        ...
        */
        ...
        final ColumnReferenceByName innerFirstCol = c.colName("t0", "entity_pk");
        final ColumnReferenceByName innerSecondCol = c.colName("t0", "entity_identity");
        final ColumnsBuilder innerSelectCols = q.columnsBuilder(SetQuantifier.DISTINCT).addUnnamedColumns(innerFirstCol,
                innerSecondCol);

        final BooleanExpression where = b.in(c.colName("t0", "entity_type_id"), l.n(3), l.n(4));
        final QuerySpecificationBuilder firstInnerQuery = q.querySpecificationBuilder();
        ...
        final TableReferenceBuilder join = t
        ...
        final QuerySpecificationBuilder secondBuilder = q.querySpecificationBuilder();
        ...
        final QueryExpressionBody innerQuery = q.queryBuilder(firstInnerQuery.createExpression())
                .except(secondBuilder.createExpression()).createExpression();

        final QuerySpecificationBuilder select = q.querySpecificationBuilder().setSelect(
    ...
    public void query3()
        ...
        final String firstCol = "firstCol";
        final String secondCol = "secondCol";
        final String schemaName = "schema";
        final String tableName = "table";

        final QueryExpression query = q.simpleQueryBuilder().select("COUNT(" + firstCol + ")", "MAX(" + secondCol + ")")
    ...
    public void query5()
        ...
        */
        ...
        final QueryExpression query = vendor.getQueryFactory().simpleQueryBuilder()
                .selectAllColumns()
