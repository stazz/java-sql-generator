...
public abstract class AbstractSQLSyntaxTest {
    ...
    protected void logStatement(final String statementType, final SQLVendor vendor, final SQLStatement statement) {
        final String stringStmt = vendor.toString(statement);
