...
public abstract class AbstractDataDefinitionTest extends AbstractSQLSyntaxTest {
    ...
    public void definition1()
        ...
        final DefinitionFactory d = vendor.getDefinitionFactory();
        final DataTypeFactory dt = vendor.getDataTypeFactory();
        final String schemaName = "qi4j_schema";

        final TableDefinitionBuilder builder = d.createTableDefinitionBuilder();
        builder
                .setTableName(t.tableName(schemaName, "qname_9"));

        final TableElementListBuilder cBuilder = d.createTableElementListBuilder();
        cBuilder
    ...
    public void definition2()
        ...
        final String schemaName = "the_schema";
        final String tableName = "the_table";
        final String colPKName = "pk_column";
        final String colValueName = "value_column";

        final TableDefinition def = d
