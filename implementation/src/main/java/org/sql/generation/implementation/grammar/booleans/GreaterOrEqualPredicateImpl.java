    ...
    implements GreaterOrEqualPredicate
{
    ...
    public GreaterOrEqualPredicateImpl( NonBooleanExpression left, NonBooleanExpression right )
    {
        this( GreaterOrEqualPredicate.class, left, right );
    }

    protected GreaterOrEqualPredicateImpl( Class<? extends GreaterOrEqualPredicate> predicateClass,
